...
import (
	...
	"github.com/tip_calculator/internal/home"
	"github.com/tip_calculator/internal/total_amount"
	"github.com/tip_calculator/public"
...
func AddRoutes(r server.Router) error {
  ...
  r.HandleFunc("GET /calculate-billing-amount", total_amount.Calculate)
